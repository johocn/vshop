...
export const menuGroups: MenuGroup[] = [
  {
    ...
    items: [
      ...
      { label: '采购入库', url: '/pages/inventory/stock-doc/purchase/index', tier: 2 },
      { label: '移库', url: '/pages/inventory/stock-doc/transfer/index', tier: 2 },
      { label: '盘库', url: '/pages/inventory/stock-doc/stocktake/index', tier: 2 },
      { label: '手动出库', url: '/pages/inventory/stock-doc/issue/index', tier: 2 },
      { label: '库存流水', url: '/pages/inventory/movements/index', tier: 2 },
